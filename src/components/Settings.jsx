...
function Settings({ closeSettings }) {
  return (
    <div className="bg-white w-full max-w-140 rounded-[15px] flex flex-col gap-4">
      ...
      <button type="button" className="bg-red-400 text-white text-[16px] leading-base font-bold w-35 h-13.25 self-center rounded-[26.5px] translate-y-6.25 -mt-2">Apply</button>
    </div>
  )
}
